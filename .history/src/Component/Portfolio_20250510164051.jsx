...
import Kavita from '../Images/kavitanchGaav-Jakatwadi.jpg';
import PocketCar from  '../Images/PocketCar.jpg';
...
<div className='Mobile-box' id="mall1">
<div className='Mall-Application'>Kavitanch Gaav Jakattwadi </div>
...
<a href="https://www.kavitanchgaavjakatwadi.in" className='Mall-Check'>Check it out! </a>

<div className='Mall-Profile'>
  <img src={MallExplorer} alt="Kavitancha-Gaav jakatwadi" className='KavitachaGaav-img'></img>
</div>
...
<div className='Mobile-box' id="mall1">
<div className='Mall-Application'>Pocket Car</div>
...
<a href="https://pocketcars.in" className='Mall-Check'>Check it out!</a>

<div className='Mall-Profile'>
  <img src={MallExplorer} alt="PocketCar" className='PocketCar-img'></img>
</div>
