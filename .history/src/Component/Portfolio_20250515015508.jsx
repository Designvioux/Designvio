  ...
  return (
    <div className='Portfolio-Container'>
      ...
      <div id="Portfolio-main">
        ...
        <div className='Mobile-box' id="mall1">
          <div className='content-left'>
            <div className='Kavita-Application'>MDL Private Limited (MDL) </div>
            <p className='Mall-info'>iMDL Automation and Controls is one of the leading supplier Company with comprehensive range of industrial valves gate valve, globe valve, check valve, ball valve, butterfly valve, forged steel valves, piston valve, Sluice valve, control valve, plug valve, knife edge gate valve, safety valve, pressure regulating valve, strainer, and lined valve with pneumatic and electric actuator operated valve automation and accessories in all sizes and different material of construction up to 2500# class..</p>
