...
import Medipro from "../Images/MediPro.png";
import FlexiFund from "../Images/FlexiFund.png";
import MallExplorer from "../Images/MallExplorer.png"
...
const PortFolio = () => {
  return (
    <div className='Portfolio-Container'>
      ...
      <div id="Portfolio-main">
        ...
        <div className='Mobile-box' id="mall1">
          <div className='content-left'>
            <div className='Kavita-Application'>MDL Automation and Controls Private Limited </div>
            <p className='Mall-info'>MDL Automation and Controls is one of the leading supplier Company with comprehensive range of industrial valves gate valve, globe valve, check valve, ball valve, butterfly valve, forged steel valves, piston valve, Sluice valve, control valve, plug valve, knife edge gate valve, safety valve, pressure regulating valve, strainer, and lined valve with pneumatic and electric actuator operated valve automation and accessories in all sizes and different material of construction up to 2500# class.</p>
            <p className='Mall-OurServices'>Our Services: <span className='Mall-Service'> Website Design</span></p>
            <button onClick={() => window.location.href = 'https://www.mdlindia.in/'} className="PocketCar-Check">
  Check it out!
</button>
          </div>
          <div className='kavita-Profile'>
            <img src={mdl} alt="MDL" className='KavitachaGaav-img'></img>
          </div>
        </div>
        ...
        <div className='Mobile-box' id="mall1">
          <div className='content-left'>
            ...
            <button onClick={() => window.location.href = 'https://kavitanchgaavjakatwadi.in/'} className="PocketCar-Check">
  Check it out!
</button>
          </div>
          <div className='kavita-Profile'>
  ...
  Check it out!
          ...
          <div className='PocketCar-Profile'>
            <img src={samarth} alt="samarth Tours Travels" className='PocketCar-img'></img>
          </div>
        </div>
      </div>
    </div>
