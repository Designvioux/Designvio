...
const Home = ({ onContactClick }) => {
  ...
  return (
    <div className="home-container">
      <Helmet>
        <title>DesignVio | Elevate Your Business with Innovative Design</title>
        <meta
          name="description"
          content="Unlock the full potential of your brand with DesignVio's cutting-edge UI/UX and full stack development courses in Satara."
        />
        <meta name="keywords" content="UI/UX, Full Stack Development, DesignVio, Satara, Innovative Design" />
      ...
      <main className="main-content">
        ...
        <p>
          Unlock the full potential of your brand with cutting-edge design
          solutions. Let’s bring your vision to life with creativity and
          strategy!
        </p>
