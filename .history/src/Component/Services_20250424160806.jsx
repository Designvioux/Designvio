...
<div className="service-grid">
        ...
        <div className="service-card">
          ...
          <p>
            Enhance your customer experience with intuitive and engaging UX/UI design. We create user-friendly interfaces and seamless interactions that keep your customers coming back. Prices start from 1800€.
          </p>
...
<div className="service-card">
          ...
          <p>
          Gain insights and direction with our expert consulting services. We provide strategic advice on branding, marketing, and digital transformation to help you navigate and thrive in the competitive landscape. Prices start from 2000€.
          </p>
          <a href="#">Ask for offer →</a>
        </div>
{/* No-code Development */}
