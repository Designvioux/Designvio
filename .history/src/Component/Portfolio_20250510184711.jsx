      ...
      <div id="Portfolio-main">
        ...
        <div className='Mobile-box' id="med1">
          <div className='content-left'>
            ...
            <a  onclick="window.location.href=''" className='Mobile-Check'>Check it out!</a>
          </div>
        ...
        <div className='Mobile-box' id="flex1">
          <div className='content-left'>
            ...
            <a className='FlexiFund-Check'>Check it out!</a>
          </div>
        ...
        <div className='Mobile-box' id="mall1">
          <div className='content-left'>
            ...
            <a className='Mall-Check'>Check it out!</a>
          </div>
        ...
        <div className='Mobile-box' id="mall1">
          <div className='content-left'>
            <div className='Kavita-Application'>Kavitanch Gaav Jakattwadi</div>
            ...
            <a href="https://www.kavitanchgaavjakatwadi.in" className='Kavita-Check'>Check it out!</a>
          </div>
        ...
        <div className='Mobile-box' id="mall1">
          <div className='content-left'>
            ...
            <a href="https://pocketcars.in" className='PocketCar-Check'>Check it out!</a>
          </div>
