...
const ContactPopUp = ({ onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Prepare body content for Gmail Compose
    const body = `Name: ${name}%0D%0AEmail: ${email}%0D%0AMobile: ${number}%0D%0A%0D%0A${message}`;

    // Gmail Compose URL with pre-filled fields
    const gmailLink = `https://mail.google.com/mail/?view=cm&fs=1&to=aniketpawar@gmail.com&su=${encodeURIComponent(subject)}&body=${body}`;
